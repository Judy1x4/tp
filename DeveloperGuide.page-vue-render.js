...
with(this){return _c('ul',[_c('li',[_v("Jane is a customer service representative at a food delivery company")]),_v(" "),_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("needs to provide quick support and personal assistance")]),_v(" "),_c('li',[_v("her main responsibilities include: responding to general inquiries and resolving issues and complaints")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions\n"),_c('ul',[_c('li',[_v("is reasonably comfortable using CLI apps")])])]),_v(" "),_c('li',[_v("works independently and does not share her computer physically with others")]),_v(" "),_c('li',[_v("occasionally need to share customer profile databases with other customer service representatives")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('p',[_v("ServiceTrack offers users "),_c('strong',[_v("convenient features")]),_v(" through CLI-first optimization, sorting, and classification, enhancing operational efficiency. Additionally, it enables personalized customer interactions by providing "),_c('strong',[_v("quick access to information")]),_v(" such as customer profiles, details, and remarks, thereby resolving inquiries more effectively and improving the customer satisfaction rate in food delivery customer service.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("add customers to the list")]),_v(" "),_c('td',[_v("store their info for the next time they call in")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("delete a customer")]),_v(" "),_c('td',[_v("remove entries that I no longer need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("find a person by name")]),_v(" "),_c('td',[_v("locate details of customers without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("edit customer profiles")]),_v(" "),_c('td',[_v("keep their information up to date in the case where it changes (e.g. due to moving house)")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("CSR with many customers in the address book")]),_v(" "),_c('td',[_v("sort customers by last update")]),_v(" "),_c('td',[_v("access the most recent data easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("create tags")]),_v(" "),_c('td',[_v("use them to categorise customers")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("tag customers with custom tags")]),_v(" "),_c('td',[_v("categorise customers")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("search customers by tags")]),_v(" "),_c('td',[_v("easily access customer groups")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("add additional remarks to customers")]),_v(" "),_c('td',[_v("record any special circumstances regarding that customer (e.g. agitates easily)")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("new CSR")]),_v(" "),_c('td',[_v("use a \"help\" command")]),_v(" "),_c('td',[_v("see how to use the app or refer to the syntax of a lesser-used command")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("add reminders for follow up calls")]),_v(" "),_c('td',[_v("follow up with customers on later dates")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("experienced CSR")]),_v(" "),_c('td',[_v("set custom keybinds/shortcuts")]),_v(" "),_c('td',[_v("use commands faster")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("undo commands")]),_v(" "),_c('td',[_v("recover from mistakes/accidents")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("archive customer profiles")]),_v(" "),_c('td',[_v("remove customers I have finished serving but still have access to their profile if needed in future")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("mark a customer as VIP")]),_v(" "),_c('td',[_v("designate them as requiring extra care")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("potential CSR")]),_v(" "),_c('td',[_v("see the app populated with sample customer contact information")]),_v(" "),_c('td',[_v("see how the app looks when it is in use")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("new CSR")]),_v(" "),_c('td',[_v("purge all current data")]),_v(" "),_c('td',[_v("get rid of the sample customer contact I used for exploring the app")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("find a backup of the data")]),_v(" "),_c('td',[_v("recover data accidentally purged")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("international CSR")]),_v(" "),_c('td',[_v("use different languages for customer data")]),_v(" "),_c('td',[_v("support internationalization (?)")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("CSR taking over another CSR")]),_v(" "),_c('td',[_v("import customer profiles")]),_v(" "),_c('td',[_v("transfer old customer profiles from another CSR")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("CSR")]),_v(" "),_c('td',[_v("export customer profiles")]),_v(" "),_c('td',[_v("so that I can transfer current customer profiles to another CSR")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ServiceTrack")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case UC1: Look up and delete a customer")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("- MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests a list of customers matching a search term")])]),_v(" "),_c('li',[_c('p',[_v("System shows matching customers")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific customer in the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook deletes the customer")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("- Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The search result is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case UC2: Add a customer")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("- MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User supplies specifications of a customer to be added")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the customer")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The supplied customer details are incomplete/invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case UC3: Set a follow-up reminder")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("- MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests a list of customers matching a search term")])]),_v(" "),_c('li',[_c('p',[_v("System shows the matching customers")])]),_v(" "),_c('li',[_c('p',[_v("User requests to add a follow-up reminder to a customer in the list")])]),_v(" "),_c('li',[_c('p',[_v("At the date/time specified, system notifies the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("- Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Process Requirement: The product needs to be developed in a breadth-first incremental manner over the project duration.")]),_v(" "),_c('li',[_v("Accessibility Requirement: The data should be stored locally and should be in a human-editable text file.")]),_v(" "),_c('li',[_v("Environment Requirement: The software should not depend on your own remote server.")]),_v(" "),_c('li',[_v("Environment Requirement: The use of third-party frameworks/libraries/services is allowed but only if they:\n"),_c('ul',[_c('li',[_v("are free, open-source (this doesn't apply to services), and have permissive license terms.")]),_v(" "),_c('li',[_v("do not require any installation by the user of your software.")]),_v(" "),_c('li',[_v("In case of services, requiring the user to create an account on a third-party service is strongly discouraged as it can result in your product being considered 'low testability'.")])])]),_v(" "),_c('li',[_v("Quality Requirement: The GUI should work well (i.e., should not cause any resolution-related inconveniences to the user) for:\n"),_c('ul',[_c('li',[_v("Standard screen resolutions 1920x1080 and higher, and")]),_v(" "),_c('li',[_v("Screen scales 100% and 125%.")])])]),_v(" "),_c('li',[_v("Quality Requirement: The GUI should be usable (i.e., all functions can be used even if the user experience is not optimal) for:\n"),_c('ul',[_c('li',[_v("Resolutions 1280x720 and higher, and")]),_v(" "),_c('li',[_v("Screen scales 150%.")])])]),_v(" "),_c('li',[_v("Portability Requirement: Package everything into a single JAR file. If you are unable to package everything into a JAR file, package the JAR file and other files needed into a single zip file.")]),_v(" "),_c('li',[_v("Size Requirement: The file sizes of the deliverables should be reasonable and not exceed the limits given below.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("DBMS")]),_v(": Database Management System e.g., MySQL")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 10 Oct 2024, 23:16:35 GMT+8]")])])])}
}];
